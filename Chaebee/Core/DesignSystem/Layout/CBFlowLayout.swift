...
/// Places intrinsic-width items from left to right and wraps them onto new rows.
struct CBFlowLayout: Layout {
    var horizontalSpacing: CGFloat = CBSpacing.small
    var verticalSpacing: CGFloat = CBSpacing.small
